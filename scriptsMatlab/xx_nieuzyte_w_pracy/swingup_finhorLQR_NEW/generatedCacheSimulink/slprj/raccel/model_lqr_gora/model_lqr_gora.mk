...
MODEL                = model_lqr_gora
MODULES              = model_lqr_gora.c model_lqr_gora_capi.c model_lqr_gora_data.c model_lqr_gora_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = model_lqr_gora.exe
MAKEFILE             = model_lqr_gora.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023a
ALT_MATLAB_ROOT      = C:/Program Files/MATLAB/R2023a
START_DIR            = C:/adamadam/elo/ZREPO/matlab/regulatory/zwykly_LQR/gora/generatedCacheSimulink
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = model_lqr_gora_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/model_lqr_gora \
