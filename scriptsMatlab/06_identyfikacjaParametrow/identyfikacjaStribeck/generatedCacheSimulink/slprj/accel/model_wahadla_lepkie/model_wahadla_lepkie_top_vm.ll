...
model_wahadla_lepkie_CGInitializeSizes_entry:
  ...
  call void @vm_paramSizeCheck(i8* %S_0, i32 152)
  ret void
}
...
ZeroCrossings_entry:
  ...
  %4 = getelementptr inbounds i8, i8* %1, i64 96
...
false1:                                           ; preds = %false
  ...
  %15 = getelementptr inbounds i8, i8* %1, i64 128
  %16 = bitcast i8* %15 to double*
  ...
  %19 = getelementptr inbounds i8, i8* %1, i64 136
...
false6:                                           ; preds = %false5
  %62 = getelementptr inbounds i8, i8* %3, i64 88
...
true15:                                           ; preds = %false10
  ...
  %85 = getelementptr inbounds i8, i8* %3, i64 96
...
true21:                                           ; preds = %false16
  %99 = getelementptr inbounds i8, i8* %3, i64 96
...
true23:                                           ; preds = %false16
  %103 = getelementptr inbounds i8, i8* %3, i64 104
...
SystemInitialize_entry:
  ...
  %13 = getelementptr inbounds i8, i8* %3, i64 128
  %14 = bitcast i8* %13 to double*
  ...
  %21 = getelementptr inbounds i8, i8* %3, i64 144
  %22 = bitcast i8* %21 to double*
