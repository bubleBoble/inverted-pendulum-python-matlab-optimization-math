%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Funkcja kosztu do optymalizatora
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ cost ] = obj_func_lsqnonlin(params, IC, meas_data, volt, odetime, options)
    ...
    [ ~, x1 ] = ode45( @( t,x ) LIP_dynamics_stribeck( t,x,params,volt,end_time ), odetime, IC, options );
    % sim_data = x1;
    sim_data = x1(:, 1:2);
    ...
    if display_intermediate_optim_params
        fprintf("Lc=%f, b=%f, gamma=%f, mr=%f, Mt=%f, L=%f, Jt=%f, alpha=%f, beta=%f\n", params);
    end
