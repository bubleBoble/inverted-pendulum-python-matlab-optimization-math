...
model_wahadla_lepkie_CGInitializeSizes_entry:
  ...
  call void @vm_paramSizeCheck(i8* %S_0, i32 192)
  ret void
}
...
ZeroCrossings_entry:
  ...
  %4 = getelementptr inbounds i8, i8* %1, i64 136
...
Outputs1_entry:
  ...
  %3 = getelementptr inbounds i8, i8* %1, i64 152
...
false1:                                           ; preds = %false
  %11 = getelementptr inbounds i8, i8* %1, i64 160
  %12 = bitcast i8* %11 to double*
  ...
  %23 = getelementptr inbounds i8, i8* %1, i64 184
...
true15:                                           ; preds = %false10
  ...
  %85 = getelementptr inbounds i8, i8* %3, i64 136
...
true21:                                           ; preds = %false16
  %99 = getelementptr inbounds i8, i8* %3, i64 136
...
SystemInitialize_entry:
  ...
  %3 = call i8* @vm_ssGetModelRtp(i8* %S)
  %4 = call i8* @vm__ssGetModelBlockIO(i8* %S)
  %5 = getelementptr inbounds i8, i8* %3, i64 152
  %6 = bitcast i8* %5 to double*
  ...
  %17 = getelementptr inbounds i8, i8* %3, i64 176
  %18 = bitcast i8* %17 to double*
