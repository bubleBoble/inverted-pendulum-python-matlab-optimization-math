...
subplot(511);
    ...
    plot(t_sim,xw_nl,Color=green,LineWidth=2,LineStyle="-");
    % plot(t_sim,xw_l,Color='magenta',LineWidth=1.5,LineStyle="--");
    % plot(t_sim,xw_ref);
    hold off;
    ax=gca;
...
subplot(512);
    ...
    % plot(t_sim,Dxw_l,Color='magenta',LineWidth=1.5,LineStyle="--"); hold off;
    ax=gca;
    ax.YAxis.FontSize = font_size;
...
subplot(513);
    ...
    % yline(1.9767*pi,Color=red,LineWidth=2,LineStyle="--");
    plot(t_sim,the_nl+1.9767*pi,Color=green,LineWidth=2,LineStyle="-")
    ax=gca;
    ax.YAxis.FontSize = font_size;
...
subplot(515);
    ...
    plot(t_sim(100:end),ctrl_sig(100:end),Color=green,LineWidth=2,LineStyle="-")
    ax=gca;
    ax.YAxis.FontSize = font_size;
...
% utils.animate(IC, Lc, 0.001, xw_nl, the_nl, p1_x1, p1_x2+3*pi/180, t_sim, t_sim, 1, "vid_new");
